...
proc init_gui { IPINST } {
  ...
  set_property tooltip {Start count is the numeber of clock cycles the master will wait before initiating/issuing any transaction.} ${C_M01_AXIS_START_COUNT}
...
proc update_PARAM_VALUE.NF { PARAM_VALUE.NF } {
	# Procedure called to update NF when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.NF { PARAM_VALUE.NF } {
	# Procedure called to validate NF
	return true
}
...
proc update_MODELPARAM_VALUE.NF { MODELPARAM_VALUE.NF PARAM_VALUE.NF } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.NF}] ${MODELPARAM_VALUE.NF}
}
